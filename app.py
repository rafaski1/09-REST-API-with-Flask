...
from flask_restful import Api, Resource, reqparse, marshal_with, abort
...
# db.create_all() (overrides data)

# creates arguments for PUT method
...
# creates arguments for PATCH (update) method
